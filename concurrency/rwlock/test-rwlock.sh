# Test case written by Prof. Mythili Vutukuru, IIT Bombay
correct=0
total=0

echo "TESTSET: Running Testcases with reader preference"
g++ -std=c++11 test-reader-pref.cpp reader-pref.c -o rwlock-reader-pref -lpthread
...
g++ -std=c++11 test-writer-pref.cpp writer-pref.c -o rwlock-writer-pref -lpthread
